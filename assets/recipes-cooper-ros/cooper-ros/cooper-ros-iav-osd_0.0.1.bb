...
ROS_CN = "cooper_ros"
ROS_BPN = "cooper_ros_iav_osd"

AMBA_ESRC = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_iav_osd"
AMBA_ESRC_BUILD = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_iav_osd"
SRC_URI = ""

DEPENDS = "opencv libeazyai libeazyai-utils libeazyai-postprocess libeazyai-io"
RDEPENDS:${PN} = "opencv libeazyai libeazyai-utils libeazyai-postprocess libeazyai-io"
