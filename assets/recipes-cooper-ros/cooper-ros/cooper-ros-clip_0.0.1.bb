...
ROS_CN = "cooper_ros"
ROS_BPN = "cooper_ros_clip"

AMBA_ESRC = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_clip"
AMBA_ESRC_BUILD = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_clip"
SRC_URI = ""

DEPENDS = "opencv nlohmann-json libtokenizers-cpp libeazyai libeazyai-utils libeazyai-postprocess libeazyai-io libeazyai-inf"
RDEPENDS:${PN} = "opencv nlohmann-json libtokenizers-cpp libeazyai libeazyai-utils libeazyai-postprocess libeazyai-io libeazyai-inf"
