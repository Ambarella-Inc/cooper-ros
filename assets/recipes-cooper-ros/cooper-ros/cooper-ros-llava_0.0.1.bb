...
ROS_CN = "cooper_ros"
ROS_BPN = "cooper_ros_llava"

AMBA_ESRC = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_llava"
AMBA_ESRC_BUILD = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_llava"
SRC_URI = ""

DEPENDS = "opencv nlohmann-json libeazyai libeazyai-utils libeazyai-postprocess libeazyai-io libcavalrymem libnnctrl libshepherd"
RDEPENDS:${PN} = "opencv nlohmann-json libeazyai libeazyai-utils libeazyai-postprocess libeazyai-io libcavalrymem libnnctrl libshepherd"
