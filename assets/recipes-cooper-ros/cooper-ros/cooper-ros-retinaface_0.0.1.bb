...
ROS_CN = "cooper_ros"
ROS_BPN = "cooper_ros_retinaface"

AMBA_ESRC = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_retinaface"
AMBA_ESRC_BUILD = "${ENV_TOP_DIR}/app/cooper_ros/cooper_ros_retinaface"
SRC_URI = ""

DEPENDS = "opencv nlohmann-json libeazyai libeazyai-utils libeazyai-postprocess"
RDEPENDS:${PN} = "opencv nlohmann-json libeazyai libeazyai-utils libeazyai-postprocess"
