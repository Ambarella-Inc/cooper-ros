...
#ifndef COOPER_ROS__RETINAFACE__RETINAFACE_NODE_HPP_
#define COOPER_ROS__RETINAFACE__RETINAFACE_NODE_HPP_
...
class RetinafaceNode : public rclcpp::Node
{
public:
  RetinafaceNode(const rclcpp::NodeOptions & options);
  virtual ~RetinafaceNode();
...
private:
  ...
  retinaface_t * retinaface_;
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr image_subscription_;
  rclcpp::Publisher<vision_msgs::msg::Detection2DArray>::SharedPtr detection_publisher_;
  rclcpp::Publisher<cooper_ros_msgs::msg::LandmarkDetection2DArray>::SharedPtr landmark_publisher_;
