...
#ifndef COOPER_ROS__YOLOX__YOLOX_NODE_HPP_
#define COOPER_ROS__YOLOX__YOLOX_NODE_HPP_
...
private:
  ...
  std::string declareString(const std::string & name, const std::string & description = "")
  {
    rcl_interfaces::msg::ParameterDescriptor desc;
    desc.description = description;

    std::string param =
      this->declare_parameter(name, std::string(""), desc, false /*ignore_override*/);
    if (param.size() == 0) {
